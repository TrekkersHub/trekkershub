		...
		<footer id="footer">
			<div class="container">
				...
				<div class="row footer-holder">
					...
					<nav class="col-sm-4 col-lg-2 footer-nav">
						<h3>ask TrekkersHub</h3>
						<ul class="slide">
							<li><a href="#">Why TrekkersHub?</a></li>
					...
					<nav class="col-sm-4 col-lg-2 footer-nav last">
						<h3>contact TrekkersHub</h3>
						<ul class="slide address-block">
							<li class="wrap-text"><span class="icon-tel"></span> <a href="tel:8291326130">(829)1326130</a></li>
							<li class="wrap-text"><span class="icon-fax"></span> <a href="tel:02088828282">(020) 88828282</a></li>
							<li class="wrap-text"><span class="icon-email"></span> <a href="mailto:info@entrada.com">info@trekkershub.com</a></li>
							<li><span class="icon-home"></span> <address>404 Andheri Road Andheri, Mumbai MAH 400053</address></li>
						</ul>
					</nav>
				</div>
				<!-- social wrap -->
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							<!-- copyright -->
							<strong class="copyright"><i class="fa fa-copyright"></i> Copyright 2016 - TrekkersHub</strong>
						</div>
						<div class="col-lg-6">
